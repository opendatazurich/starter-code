...
- **Keywords** `Bildung,Kultur,Soziales`
- **Tags** `['Afrika', 'Alaska', 'Archiv', 'Ethnologie', 'Gebrauchsgegenstände', 'Himmelheber', 'Kunst', 'Maske', 'Objekte', 'Reisen', 'Sammlung', 'github']`
- **Metadata_created** `2023-06-26T08:58:26.614316`
- **Metadata_modified** `2025-09-22T17:16:33.927627`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/mrz_himmelheber_objekte/download/mrz_himmelheber_objekte.parquet"
