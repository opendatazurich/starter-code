...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/bfs_bev_bildungsstand_statquartier_od1012)

Auto generated R starter code for data set bfs_bev_bildungsstand_statquartier_od1012.
...
- **Tags** `['bevoelkerungsbestand', 'bildung', 'bildungsstand', 'sachdaten', 'sasa', 'tabelle', 'zeitreihe']`
- **Metadata_created** `2021-03-25T15:24:35.567011`
- **Metadata_modified** `2025-10-11T21:08:55.379676`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/bfs_bev_bildungsstand_statquartier_od1012/download/BIL101OD1012.csv"
