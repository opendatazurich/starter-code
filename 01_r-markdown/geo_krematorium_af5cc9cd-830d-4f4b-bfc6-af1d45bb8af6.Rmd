...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Krematorium»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/9766d049-922c-4915-a389-8529a23e1093).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/9766d049-922c-4915-a389-8529a23e1093.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_krematorium)

Auto generated R starter code for data set geo_krematorium.
...
- **Tags** `['geodaten', 'geoportal', 'krematorium', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:55:30.461923`
- **Metadata_modified** `2026-05-16T06:39:59.952710`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Krematorium?format=geojson_link"
```
