...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_quartiertreff)

Auto generated R starter code for data set geo_quartiertreff.
...
- **Metadata_created** `2026-04-29T05:46:44.796961`
- **Metadata_modified** `2026-05-13T06:33:03.237626`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Quartiertreff?format=geojson_link"
```
