...
- **Metadata_modified** `2025-03-17T04:39:06.660011`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Aktuelle_Auflistung_von_Videokameras_der_Stadtverwaltung_Zuerich?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Aktuelle_Auflistung_von_Videokameras_der_Stadtverwaltung_Zuerich?format=geojson_link", typename)
```
