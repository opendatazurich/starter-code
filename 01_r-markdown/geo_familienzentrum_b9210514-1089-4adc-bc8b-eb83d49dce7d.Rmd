...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_familienzentrum)

Auto generated R starter code for data set geo_familienzentrum.
...
- **Tags** `['eltern-kind-zentrum', 'familien', 'geodaten', 'geoportal', 'kinderhaus', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:53:52.497831`
- **Metadata_modified** `2026-06-27T06:43:03.481535`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Familienzentrum?format=geojson_link"
```
