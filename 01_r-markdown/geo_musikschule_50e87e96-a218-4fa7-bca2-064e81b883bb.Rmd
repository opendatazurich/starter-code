...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Musikschule»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/9db06d69-4302-4ef3-9991-850f361e36f5).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/9db06d69-4302-4ef3-9991-850f361e36f5.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_musikschule)

Auto generated R starter code for data set geo_musikschule.
...
- **Metadata_created** `2026-04-29T05:49:16.937015`
- **Metadata_modified** `2026-06-20T06:42:51.170143`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Musikschule?format=geojson_link"
```
