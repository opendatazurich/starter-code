...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Spitex»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ab5446a7-3fe7-4bd9-8748-69d5e26c0916).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/ab5446a7-3fe7-4bd9-8748-69d5e26c0916.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_spitex)

Auto generated R starter code for data set geo_spitex.
...
- **Tags** `['geodaten', 'geoportal', 'pflege', 'punktdaten', 'spitex', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:42:31.689552`
- **Metadata_modified** `2026-05-30T06:34:04.496728`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Spitex?format=geojson_link"
```
