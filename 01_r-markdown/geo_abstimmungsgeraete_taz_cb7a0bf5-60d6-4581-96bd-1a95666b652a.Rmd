...
- **Metadata_modified** `2025-03-17T04:38:50.518800`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Abstimmungsgeraete_TAZ?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Abstimmungsgeraete_TAZ?format=geojson_link", typename)
```
