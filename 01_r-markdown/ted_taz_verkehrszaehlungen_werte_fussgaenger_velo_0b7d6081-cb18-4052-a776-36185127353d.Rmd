...
- **Tags** `['fussgaengerzaehlung', 'fussverkehr', 'langsamverkehr', 'messwerte', 'planung', 'punktdaten', 'sachdaten', 'standort', 'veloverkehr', 'velozaehlung', 'zaehlung']`
- **Metadata_created** `2020-03-16T12:37:39.927543`
- **Metadata_modified** `2025-05-26T06:04:34.006843`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/ted_taz_verkehrszaehlungen_werte_fussgaenger_velo/download/2015_verkehrszaehlungen_werte_fussgaenger_velo.csv"
