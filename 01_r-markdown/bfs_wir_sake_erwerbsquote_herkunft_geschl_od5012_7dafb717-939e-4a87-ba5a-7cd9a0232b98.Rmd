...
Bei der Erwerbsquote handelt es sich um den Anteil der Erwerbspersonen (Erwerbstätige und Erwerbslose gemäss ILO) an der ständigen Bevölkerung im Alter von 15 Jahren und mehr.
...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/bfs_wir_sake_erwerbsquote_herkunft_geschl_od5012)

Auto generated R starter code for data set bfs_wir_sake_erwerbsquote_herkunft_geschl_od5012.
...
- **Metadata_created** `2024-08-12T15:08:34.082935`
- **Metadata_modified** `2026-01-20T07:00:30.132805`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/bfs_wir_sake_erwerbsquote_herkunft_geschl_od5012/download/WIR501OD5012.csv"
