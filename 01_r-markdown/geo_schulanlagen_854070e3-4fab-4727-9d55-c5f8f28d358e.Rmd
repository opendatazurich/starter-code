...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Schulanlagen»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ce76ccc1-a094-4665-8ccc-ec8f50a16c2b).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Schulanlagen»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/ce76ccc1-a094-4665-8ccc-ec8f50a16c2b).
...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_schulanlagen)

Auto generated R starter code for data set geo_schulanlagen.
...
- **Tags** `['bildung', 'geodaten', 'geoportal', 'kindergarten', 'kinderhort', 'punktdaten', 'schule', 'sonderschule', 'stzh', 'volksschule']`
- **Metadata_created** `2026-04-29T05:50:08.193942`
- **Metadata_modified** `2026-05-30T06:43:41.287025`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Schulanlagen?format=geojson_link"
```
