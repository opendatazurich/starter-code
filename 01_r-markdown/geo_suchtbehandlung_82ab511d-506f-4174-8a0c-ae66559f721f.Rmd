...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Suchtbehandlung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/d8bed8ff-8ce1-47b8-a73a-0ed3d0ca706f).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/d8bed8ff-8ce1-47b8-a73a-0ed3d0ca706f.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_suchtbehandlung)

Auto generated R starter code for data set geo_suchtbehandlung.
...
- **Keywords** `Ge­sund­heit`
- **Tags** `['geodaten', 'geoportal', 'gesundheit', 'punktdaten', 'stzh', 'suchtbehandlung', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:44:56.425778`
- **Metadata_modified** `2026-06-06T06:35:09.204573`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Suchtbehandlung?format=geojson_link"
```
