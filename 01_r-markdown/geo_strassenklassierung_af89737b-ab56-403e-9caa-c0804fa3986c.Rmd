...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Strassenklassierung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/f568a2d8-f69c-4280-90ed-f80eaa78e387).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/f568a2d8-f69c-4280-90ed-f80eaa78e387.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_strassenklassierung)

Auto generated R starter code for data set geo_strassenklassierung.
...
- **Keywords** ``
- **Tags** `['geodaten', 'geoportal', 'liniendaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:49:29.458833`
- **Metadata_modified** `2026-05-09T06:38:13.903980`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Strassenklassierung?format=geojson_link"
```
