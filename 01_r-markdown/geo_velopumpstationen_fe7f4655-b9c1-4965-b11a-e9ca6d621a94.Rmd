...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Velopumpstationen»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/680641aa-6de9-816c-0a80-37dfe43b32b4).				
...
Finden Sie unter diesem [**Link**](https://www.stadt-zuerich.ch/de/mobilitaet/velo/angebote-fuer-das-velo.html)

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/680641aa-6de9-816c-0a80-37dfe43b32b4.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_velopumpstationen)

Auto generated R starter code for data set geo_velopumpstationen.
...
- **Keywords** `Mobilität`
- **Tags** `['druckluft', 'geodaten', 'geoportal', 'handpumpe', 'luft', 'masterplan-velo', 'pneu', 'punktdaten', 'stzh', 'vektordaten', 'velo', 'velopumpstationen', 'zweirad']`
- **Metadata_created** `2026-04-29T05:52:48.814893`
- **Metadata_modified** `2026-06-27T06:41:58.290909`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Velopumpstationen?format=geojson_link"
```
