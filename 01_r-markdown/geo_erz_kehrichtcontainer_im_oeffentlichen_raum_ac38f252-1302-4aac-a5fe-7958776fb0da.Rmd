...
Weitere Informationen zu diesem Datensatz finden sie unter [«**ERZ Kehrichtcontainer im öffentlichen Raum»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/7e77d9d9-2f7a-4e19-b2aa-b7cc431bfdc8).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/7e77d9d9-2f7a-4e19-b2aa-b7cc431bfdc8.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_erz_kehrichtcontainer_im_oeffentlichen_raum)

Auto generated R starter code for data set geo_erz_kehrichtcontainer_im_oeffentlichen_raum.
...
- **Tags** `['entsorgung-kehricht-haushaltkehricht-betriebskehricht-container', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:42:21.856564`
- **Metadata_modified** `2026-05-30T06:33:54.048552`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/ERZ_Kehrichtcontainer_im_oeffentlichen_Raum?format=geojson_link"
```
