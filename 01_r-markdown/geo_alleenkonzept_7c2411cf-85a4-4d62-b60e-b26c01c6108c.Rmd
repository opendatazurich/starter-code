...
- **Metadata_modified** `2025-03-17T04:36:52.891554`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Alleenkonzept?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Alleenkonzept?format=geojson_link", typename)
```
