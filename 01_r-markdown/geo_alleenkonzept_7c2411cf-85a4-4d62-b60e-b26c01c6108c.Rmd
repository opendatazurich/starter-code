...
- **Metadata_modified** `2025-03-03T04:36:48.987371`
...
df <- read_geodata("# name: 		Alleenkonzept.json (GeoJSON-Services)
# filename: 		nan
# format: 		JSON
# url: 		https://www.stadt-zuerich.ch/geodaten/download/Alleenkonzept?format=geojson_link
# id: 		7c2411cf-85a4-4d62-b60e-b26c01c6108c
...
library(readr) 
df <- read_csv("https://www.stadt-zuerich.ch/geodaten/download/Alleenkonzept?format=geojson_link")", typename)
```
