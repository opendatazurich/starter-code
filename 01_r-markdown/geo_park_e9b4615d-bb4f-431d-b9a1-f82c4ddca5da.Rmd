...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_park)

Auto generated R starter code for data set geo_park.
...
- **Tags** `['geodaten', 'geoportal', 'parkanlagen', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:40:17.751574`
- **Metadata_modified** `2026-05-06T06:33:54.048636`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Park?format=geojson_link"
```
