...
- **Metadata_modified** `2025-03-17T04:31:23.980009`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Alterszentrum?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Alterszentrum?format=geojson_link", typename)
```
