...
- **Metadata_modified** `2025-02-26T04:31:22.953936`
...
df <- read_geodata("# name: 		Alterszentrum.json (GeoJSON-Services)
# filename: 		nan
# format: 		JSON
# url: 		https://www.stadt-zuerich.ch/geodaten/download/Alterszentrum?format=geojson_link
# id: 		86da6519-1cae-4518-97be-4536c8ff2d5b
...
library(readr) 
df <- read_csv("https://www.stadt-zuerich.ch/geodaten/download/Alterszentrum?format=geojson_link")", typename)
```
