...
Weitere Informationen zu diesem Datensatz finden sie unter [«**VBZ-Baustellen»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/7c8f5615-3285-46ec-9767-3439bd846fd6).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/7c8f5615-3285-46ec-9767-3439bd846fd6.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_vbz_baustellen)

Auto generated R starter code for data set geo_vbz_baustellen.

## Metadata

- **Publisher** `Fahrgastinfo / Produktmanagement, Verkehrsbetriebe, Departement der Industriellen Betriebe`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords** `Mobilität`
- **Tags** `['baustellen', 'bus', 'buslinien', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'tram', 'tramlinien', 'vbz', 'veranstaltungen']`
- **Metadata_created** `2026-04-29T05:54:37.532994`
- **Metadata_modified** `2026-05-07T06:41:28.026041`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/VBZ_Baustellen?format=geojson_link"
```
