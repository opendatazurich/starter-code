...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Spitalnotaufnahme»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/1571c1a0-bc34-453e-a506-9c3705ece2b1).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/1571c1a0-bc34-453e-a506-9c3705ece2b1.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_spitalnotaufnahme)

Auto generated R starter code for data set geo_spitalnotaufnahme.
...
- **Tags** `['geodaten', 'geoportal', 'gesundheit', 'punktdaten', 'spital', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:41:36.332181`
- **Metadata_modified** `2026-05-07T06:32:15.639421`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Spitalnotaufnahme?format=geojson_link"
```
