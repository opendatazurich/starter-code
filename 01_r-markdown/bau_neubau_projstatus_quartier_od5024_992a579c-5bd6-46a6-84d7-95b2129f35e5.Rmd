...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/bau_neubau_projstatus_quartier_od5024)

Auto generated R starter code for data set bau_neubau_projstatus_quartier_od5024.
...
- **Tags** `['bauen-und-wohnen', 'bautaetigkeit', 'eigentum', 'gebaeude', 'neubau', 'sachdaten', 'sasa', 'tabelle', 'zeitreihe']`
- **Metadata_created** `2026-01-27T20:55:18.399071`
- **Metadata_modified** `2026-03-01T04:10:45.284039`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/bau_neubau_projstatus_quartier_od5024/download/BAU502OD5024.csv"
