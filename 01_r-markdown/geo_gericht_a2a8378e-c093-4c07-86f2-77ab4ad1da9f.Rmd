...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_gericht)

Auto generated R starter code for data set geo_gericht.
...
- **Tags** `['anwalt', 'geodaten', 'geoportal', 'gerichte', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:54:42.096385`
- **Metadata_modified** `2026-06-13T06:48:23.977883`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Gericht?format=geojson_link"
```
