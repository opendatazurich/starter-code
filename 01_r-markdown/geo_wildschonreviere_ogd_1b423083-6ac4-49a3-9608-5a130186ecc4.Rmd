...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Wildschonreviere OGD»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ea25183b-1557-4a46-9f1c-523a979879ca).				
			   

**Datenerfassung:**

Digitalisiert auf der Basis der kantonalen Jagdreviere

**Datengrundlage:**

Kantonale Jagdreviere

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/ea25183b-1557-4a46-9f1c-523a979879ca.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_wildschonreviere_ogd)

Auto generated R starter code for data set geo_wildschonreviere_ogd.
...
- **Keywords** `Basis­karten,Umwelt`
- **Tags** `['geodaten', 'geoportal', 'polygondaten', 'revier', 'stzh', 'vektordaten', 'wild', 'wildhut']`
- **Metadata_created** `2026-04-29T05:50:45.150873`
- **Metadata_modified** `2026-05-13T06:33:51.128409`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Wildschonreviere_OGD?format=geojson_link"
```
