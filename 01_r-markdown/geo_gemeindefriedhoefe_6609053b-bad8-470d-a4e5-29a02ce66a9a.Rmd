...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Gemeindefriedhöfe»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/72bc4dba-fadb-4ce3-b60f-0e10699c9e94).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/72bc4dba-fadb-4ce3-b60f-0e10699c9e94.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_gemeindefriedhoefe)

Auto generated R starter code for data set geo_gemeindefriedhoefe.
...
- **Tags** `['friedhof', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:43:09.929662`
- **Metadata_modified** `2026-06-27T06:33:35.721221`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Gemeindefriedhoefe?format=geojson_link"
```
