...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/bfs_wir_besch_vzaeq_jahr_od4001)

Auto generated R starter code for data set bfs_wir_besch_vzaeq_jahr_od4001.
...
- **Tags** `['beschaeftigte', 'sachdaten', 'sasa', 'tabelle', 'vollzeitaequivalente', 'zeitreihe']`
- **Metadata_created** `2024-02-23T08:28:13.556379`
- **Metadata_modified** `2026-01-03T21:26:46.945129`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/bfs_wir_besch_vzaeq_jahr_od4001/download/WIR400OD4001.csv"
