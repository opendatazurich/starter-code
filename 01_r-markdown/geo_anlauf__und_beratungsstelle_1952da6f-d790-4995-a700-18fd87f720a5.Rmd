...
- **Metadata_modified** `2025-03-24T04:32:23.334357`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Anlauf__und_Beratungsstelle?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Anlauf__und_Beratungsstelle?format=geojson_link", typename)
```
