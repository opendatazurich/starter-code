...
Im folgenden ER Modell wird beschrieben wie die Zählstellen aufgebaut sind, damit die die hier zur Verfügung gestellten Zähldaten einfacher interpretiert werden können:
...
- **Metadata_modified** `2025-05-26T06:01:33.144117`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/sid_dav_verkehrszaehlung_miv_od2031/download/sid_dav_verkehrszaehlung_miv_OD2031_2017.csv"
