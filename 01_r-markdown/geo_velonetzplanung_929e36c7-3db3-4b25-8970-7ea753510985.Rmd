...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Velonetzplanung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ef25a3f8-1942-4aba-915d-96da50394f92).
			   

**Datenerfassung:**

Erfassung gemäss PDF-Plan. Erfassung basiert grundsätzlich auf VAS (Verkehrsachsensystem der Stadt Zürich) mit Ergänzungen bzw. Abweichungen.

**Datengrundlage:**

Erarbeitung durch TAZ

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Velonetzplanung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/ef25a3f8-1942-4aba-915d-96da50394f92).

***VIEW_GS_UMSETZUNGSSTRECKEN***: 
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/ef25a3f8-1942-4aba-915d-96da50394f92.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_velonetzplanung)

Auto generated R starter code for data set geo_velonetzplanung.
...
- **Keywords** `Mobilität`
- **Tags** `['geodaten', 'geoportal', 'liniendaten', 'stzh', 'vektordaten', 'velo', 'velonetz', 'vorzougsrouten']`
- **Metadata_created** `2026-04-29T05:54:33.610109`
- **Metadata_modified** `2026-05-30T06:48:20.719872`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Velonetzplanung?format=geojson_link"
```
