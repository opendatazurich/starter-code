...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/bau_hae_preis_stockwerkeigentum_gebaeudealter_od5158)

Auto generated R starter code for data set bau_hae_preis_stockwerkeigentum_gebaeudealter_od5158.
...
- **Tags** `['gebaeudealter', 'handaenderungen', 'liegenschaftenhandel', 'median', 'quadratmeterpreis', 'sachdaten', 'sasa', 'stockwerkeigentum', 'tabelle', 'transaktionsvolumen', 'wohnungsflaeche', 'zeitreihe']`
- **Metadata_created** `2023-11-21T09:32:08.979015`
- **Metadata_modified** `2026-01-24T21:15:01.581734`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/bau_hae_preis_stockwerkeigentum_gebaeudealter_od5158/download/BAU515OD5158.csv"
