...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Zweiradparkierung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/dcc0f444-20f7-42de-ac44-3182456026a0).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/dcc0f444-20f7-42de-ac44-3182456026a0.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_zweiradparkierung)

Auto generated R starter code for data set geo_zweiradparkierung.
...
- **Metadata_created** `2026-04-29T05:46:05.762808`
- **Metadata_modified** `2026-05-09T06:35:39.866693`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Zweiradparkierung?format=geojson_link"
```
