...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Mütter- und Väterberatung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/233ab045-6cd6-4263-a2cd-77d10c5b3790).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Mütter- und Väterberatung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/233ab045-6cd6-4263-a2cd-77d10c5b3790).
...
Standorte der Mütter- und Vätterberatungsstellen
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/233ab045-6cd6-4263-a2cd-77d10c5b3790.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_muetter__und_vaeterberatung)

Auto generated R starter code for data set geo_muetter__und_vaeterberatung.
...
- **Metadata_created** `2023-11-06T03:14:55.393932`
- **Metadata_modified** `2025-07-26T06:36:05.090995`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Muetter__und_Vaeterberatung?format=geojson_link"
```
