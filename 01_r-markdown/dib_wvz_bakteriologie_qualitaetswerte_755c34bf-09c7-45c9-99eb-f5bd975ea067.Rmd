...
- **Tags** `['gitlab', 'mikrobiologie', 'sachdaten', 'tabelle', 'trinkwasser', 'trinkwasserqualitaet', 'verteilnetz', 'zeitreihe']`
- **Metadata_created** `2025-01-29T12:23:15.450002`
- **Metadata_modified** `2026-06-27T22:56:57.654987`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/dib_wvz_bakteriologie_qualitaetswerte/download/2025_Bakteriologie_Reservoire_Verteilnetz_Endstraenge.csv"
