...
## Dataset: Inventar der Natur- und Landschaftsschutzobjekte von kommunaler Bedeutung
...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Inventar der Natur- und Landschaftsschutzobjekte von kommunaler Bedeutung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/db38bd0b-984a-eaa9-0e29-f47f0dfec618).
...
Finden Sie unter diesem [**Link**](http://www.stadt-zuerich.ch/content/ted/de/index/gsz/planung_u_bau/inventare_und_grundlagen/naturschutz-inventar_und_kartierungen.html)

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Inventar der Natur- und Landschaftsschutzobjekte von kommunaler Bedeutung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/db38bd0b-984a-eaa9-0e29-f47f0dfec618).
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/db38bd0b-984a-eaa9-0e29-f47f0dfec618.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_inventar_der_natur__und_landschaftsschutzobjekte_von_kommunaler_bedeutung)

Auto generated R starter code for data set geo_inventar_der_natur__und_landschaftsschutzobjekte_von_kommunaler_bedeutung.
...
- **Keywords** `Umwelt`
- **Tags** `['biologie', 'geodaten', 'geoportal', 'polygondaten', 'punktdaten', 'stzh', 'umwelt', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:41:05.457630`
- **Metadata_modified** `2026-05-09T06:32:12.287091`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Inventar_der_Natur__und_Landschaftsschutzobjekte_von_kommunaler_Bedeutung?format=geojson_link"
```
