...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Spital»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/0d1ef665-fbc4-4b98-b357-211ae54a5060).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/0d1ef665-fbc4-4b98-b357-211ae54a5060.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_spital)

Auto generated R starter code for data set geo_spital.
...
- **Metadata_created** `2026-04-29T05:39:56.831713`
- **Metadata_modified** `2026-05-30T06:31:49.400005`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Spital?format=geojson_link"
```
