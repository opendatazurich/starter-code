...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_dienstleistungen)

Auto generated R starter code for data set geo_dienstleistungen.
...
- **Keywords** `Bevölk­erung,Mobilität,Umwelt`
- **Tags** `['dienstleistung', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:50:56.450094`
- **Metadata_modified** `2026-06-20T06:44:35.044860`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Dienstleistungen?format=geojson_link"
```
