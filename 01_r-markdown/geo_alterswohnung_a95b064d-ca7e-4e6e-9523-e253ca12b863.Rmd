...
- **Metadata_modified** `2025-03-17T04:37:43.179475`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Alterswohnung?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Alterswohnung?format=geojson_link", typename)
```
