...
- **Metadata_modified** `2025-02-26T04:37:43.010194`
...
df <- read_geodata("# name: 		Alterswohnung.json (GeoJSON-Services)
# filename: 		nan
# format: 		JSON
# url: 		https://www.stadt-zuerich.ch/geodaten/download/Alterswohnung?format=geojson_link
# id: 		a95b064d-ca7e-4e6e-9523-e253ca12b863
...
library(readr) 
df <- read_csv("https://www.stadt-zuerich.ch/geodaten/download/Alterswohnung?format=geojson_link")", typename)
```
