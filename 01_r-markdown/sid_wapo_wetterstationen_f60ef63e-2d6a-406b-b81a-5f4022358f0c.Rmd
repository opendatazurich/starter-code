...
- **Tags** `['api', 'echtzeitdaten', 'feuchte', 'github', 'hitze', 'kälte', 'sachdaten', 'sturm', 'tabelle', 'temperatur', 'wetter', 'zeitreihe']`
- **Metadata_created** `2022-07-12T15:22:11.076091`
- **Metadata_modified** `2026-02-22T04:11:26.145348`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/sid_wapo_wetterstationen/download/messwerte_tiefenbrunnen_seit2007-heute.parquet"
