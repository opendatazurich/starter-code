...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Purzelbaum»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/eeeab97b-d61d-4e5b-886e-83e6dd88b428).				
			   

**Datengrundlage:**

Referenzierung der Adressdaten mit dem Adressdatensatz des Bundes (GWR).

**Weitere Informationen zu diesem Thema:**

Finden Sie unter diesem [**Link**](https://www.stadt-zuerich.ch/purzelbaum)

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/eeeab97b-d61d-4e5b-886e-83e6dd88b428.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_purzelbaum)

Auto generated R starter code for data set geo_purzelbaum.
...
- **Tags** `['bewegung', 'geodaten', 'geoportal', 'kiga', 'kindergarten', 'kindertagesstatten', 'kita', 'punktdaten', 'purzelbaum', 'schulklassen', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:44:11.617968`
- **Metadata_modified** `2026-05-13T06:32:27.729322`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Purzelbaum?format=geojson_link"
```
