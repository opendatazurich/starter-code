...
- **Keywords** `Umwelt`
- **Tags** `['abwasser', 'abwassermenge', 'gitlab', 'klaerwerk', 'wasser']`
- **Metadata_created** `2025-10-06T13:30:49.599868`
- **Metadata_modified** `2026-02-11T08:13:29.065053`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/erz_abwassermenge_klaerwerk_werdhoelzli/download/erz_abwassermenge_klaerwerk_werdhoelzli.csv"
