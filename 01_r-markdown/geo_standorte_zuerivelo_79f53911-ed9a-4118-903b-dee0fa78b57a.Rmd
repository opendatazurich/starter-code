...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Standorte ZüriVelo»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/a7e477f1-75ce-46d2-a32a-c547e37ccfaf).				
			   

**Datenerfassung:**

Schnittstelle von PubliBike
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/a7e477f1-75ce-46d2-a32a-c547e37ccfaf.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_standorte_zuerivelo)

Auto generated R starter code for data set geo_standorte_zuerivelo.
...
- **Keywords** `Mobilität`
- **Tags** `['geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten', 'velo-verleih-veloverleih-zuri-zurivelo-publibike-stationen']`
- **Metadata_created** `2026-04-29T05:53:03.429541`
- **Metadata_modified** `2026-05-06T06:46:02.470365`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Standorte_ZueriVelo?format=geojson_link"
```
