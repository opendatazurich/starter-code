...
Öffentliche Beschlüsse des Stadtrats der Stadt Zürich, seit 2010
...
- **Tags** `['beschluss', 'geschaefte', 'github', 'regierung', 'sachdaten', 'stadtrat', 'strb', 'tabelle']`
- **Metadata_created** `2025-04-22T07:44:13.088599`
- **Metadata_modified** `2026-05-06T13:58:38.696941`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/av_skz_strb_oe_datum/download/skz-beschluesse.parquet"
