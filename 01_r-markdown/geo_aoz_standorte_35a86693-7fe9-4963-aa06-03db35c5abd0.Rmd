...
- **Metadata_modified** `2025-02-26T04:36:10.697715`
...
df <- read_geodata("# name: 		AOZ_Standorte.json (GeoJSON-Services)
# filename: 		nan
# format: 		JSON
# url: 		https://www.stadt-zuerich.ch/geodaten/download/AOZ_Standorte?format=geojson_link
# id: 		35a86693-7fe9-4963-aa06-03db35c5abd0
...
library(readr) 
df <- read_csv("https://www.stadt-zuerich.ch/geodaten/download/AOZ_Standorte?format=geojson_link")", typename)
```
