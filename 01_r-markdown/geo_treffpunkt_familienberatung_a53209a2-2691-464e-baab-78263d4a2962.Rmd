...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Treffpunkt Familienberatung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ec8b64fe-20de-417c-aa07-7bd5ddc7a643).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Treffpunkt Familienberatung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/ec8b64fe-20de-417c-aa07-7bd5ddc7a643).
...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_treffpunkt_familienberatung)

Auto generated R starter code for data set geo_treffpunkt_familienberatung.
...
- **Tags** `['geodaten', 'geoportal', 'punktdaten', 'quartiere', 'stzh']`
- **Metadata_created** `2026-04-29T05:40:22.028802`
- **Metadata_modified** `2026-05-06T06:33:56.891285`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Treffpunkt_Familienberatung?format=geojson_link"
```
