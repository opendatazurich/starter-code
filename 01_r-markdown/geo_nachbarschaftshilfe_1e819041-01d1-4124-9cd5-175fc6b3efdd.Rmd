...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_nachbarschaftshilfe)

Auto generated R starter code for data set geo_nachbarschaftshilfe.
...
- **Metadata_created** `2026-04-29T05:47:30.830617`
- **Metadata_modified** `2026-05-07T06:36:35.456986`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Nachbarschaftshilfe?format=geojson_link"
```
