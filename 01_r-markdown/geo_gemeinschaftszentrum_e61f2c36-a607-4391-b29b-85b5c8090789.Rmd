...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_gemeinschaftszentrum)

Auto generated R starter code for data set geo_gemeinschaftszentrum.
...
- **Metadata_created** `2026-04-29T05:49:03.906633`
- **Metadata_modified** `2026-05-07T06:37:32.710556`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Gemeinschaftszentrum?format=geojson_link"
```
