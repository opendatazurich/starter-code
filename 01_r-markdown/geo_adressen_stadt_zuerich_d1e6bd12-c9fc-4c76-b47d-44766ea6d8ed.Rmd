...
- **Metadata_modified** `2025-03-17T04:33:36.774252`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/Adressen_Stadt_Zuerich?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/Adressen_Stadt_Zuerich?format=geojson_link", typename)
```
