...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Hydranten»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/d07c48fc-89a9-40d6-b48c-3939c5dcc3da).				
			   

**Datenerfassung:**

Alle Hydranten werden bei deren Erstellung mittels gps erfasst und dann im GIS integriert..

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/d07c48fc-89a9-40d6-b48c-3939c5dcc3da.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_hydranten)

Auto generated R starter code for data set geo_hydranten.
...
- **Tags** `['geodaten', 'geoportal', 'hydranten', 'punktdaten', 'stzh', 'vektordaten', 'wasserversorgung']`
- **Metadata_created** `2026-04-29T05:57:02.945848`
- **Metadata_modified** `2026-05-23T06:40:36.393939`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Hydranten?format=geojson_link"
```
