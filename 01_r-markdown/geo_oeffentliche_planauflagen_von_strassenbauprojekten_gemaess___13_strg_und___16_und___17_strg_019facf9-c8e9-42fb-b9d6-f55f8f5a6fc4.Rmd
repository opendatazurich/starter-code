...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Öffentliche Planauflagen von Strassenbauprojekten gemäss § 13 StrG und § 16 und § 17 StrG»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/b2f7a748-024f-4108-b24c-095227170881).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/b2f7a748-024f-4108-b24c-095227170881.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_oeffentliche_planauflagen_von_strassenbauprojekten_gemaess___13_strg_und___16_und___17_strg)

Auto generated R starter code for data set geo_oeffentliche_planauflagen_von_strassenbauprojekten_gemaess___13_strg_und___16_und___17_strg.
...
- **Metadata_created** `2026-04-29T05:54:47.880836`
- **Metadata_modified** `2026-05-07T06:41:34.174203`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Oeffentliche_Planauflagen_von_Strassenbauprojekten_gemaess___13_StrG_und___16_und___17_StrG?format=geojson_link"
```
