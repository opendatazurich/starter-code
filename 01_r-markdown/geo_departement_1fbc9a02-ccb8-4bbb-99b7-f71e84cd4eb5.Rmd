...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_departement)

Auto generated R starter code for data set geo_departement.
...
- **Tags** `['departement', 'geodaten', 'geoportal', 'punktdaten', 'sekretariate', 'stzh', 'vektordaten', 'verwaltung']`
- **Metadata_created** `2026-04-29T05:48:20.312179`
- **Metadata_modified** `2026-05-30T06:41:32.374524`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Departement?format=geojson_link"
```
