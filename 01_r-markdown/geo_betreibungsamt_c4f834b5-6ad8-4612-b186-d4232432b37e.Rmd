...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Betreibungsamt»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/626c375b-2e0b-4987-88f1-3928f3504855).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/626c375b-2e0b-4987-88f1-3928f3504855.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_betreibungsamt)

Auto generated R starter code for data set geo_betreibungsamt.
...
- **Tags** `['betreibung', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:40:09.312006`
- **Metadata_modified** `2026-05-30T06:31:59.824007`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Betreibungsamt?format=geojson_link"
```
