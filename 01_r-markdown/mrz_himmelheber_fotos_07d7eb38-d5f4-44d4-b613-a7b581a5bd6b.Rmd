...
- **Tags** `['Afrika', 'Alaska', 'Archiv', 'Ethnologie', 'Fotografie', 'Himmelheber', 'Kunst', 'Reisen', 'github']`
- **Metadata_created** `2023-06-26T08:59:40.412170`
- **Metadata_modified** `2026-02-11T14:55:05.797883`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/mrz_himmelheber_fotos/download/mrz_himmelheber_fotos.csv"
