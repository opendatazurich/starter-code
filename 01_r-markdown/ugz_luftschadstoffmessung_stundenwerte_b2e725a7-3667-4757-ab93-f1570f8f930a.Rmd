...
- **Metadata_modified** `2025-07-20T03:53:38.536365`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/ugz_luftschadstoffmessung_stundenwerte/download/ugz_ogd_air_h1_2022.csv"
