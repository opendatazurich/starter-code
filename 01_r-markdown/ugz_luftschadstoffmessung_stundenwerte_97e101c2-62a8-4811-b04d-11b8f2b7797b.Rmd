...
- **Metadata_modified** `2026-01-04T04:00:42.896502`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/ugz_luftschadstoffmessung_stundenwerte/download/ugz_ogd_air_h1_2023.csv"
