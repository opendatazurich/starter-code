...
- **Metadata_modified** `2025-02-24T06:11:44.936202`
...
# name: 		abstimmungen_seit1933.parquet
# filename: 		abstimmungen_seit1933.parquet
# format: 		parquet
# url: 		https://data.stadt-zuerich.ch/dataset/politik_abstimmungen_seit1933/download/abstimmungen_seit1933.parquet
# id: 		3e87b102-f19c-47f4-ab50-a679b51cf77e
# resource_type: 		None
# package_id: 		b4a9dd6d-6739-4bec-bc8e-5f0b4b65994e

library(arrow) 
df <- read_parquet("https://data.stadt-zuerich.ch/dataset/politik_abstimmungen_seit1933/download/abstimmungen_seit1933.parquet")
