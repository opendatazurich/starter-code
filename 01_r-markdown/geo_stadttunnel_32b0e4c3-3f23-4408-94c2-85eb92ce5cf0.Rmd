...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Stadttunnel»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/efa924d1-30e7-43b9-8311-f12d0298eb59).				
			   

**Datenerfassung:**

aufgenommen im Auftrag des Tiefbauamts des Kantons Zürich von SEZ Ingenieurgemeinschaft Eichberger AG (Letten - Sihlhölzli, Stand: 31.10.1969) sowie Ingenieurbureau Heierli (Irchel - Letten, Stand: 23.10.1989)

**Datengrundlage:**

abdigitalisiert aus Projektierungsplan

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/efa924d1-30e7-43b9-8311-f12d0298eb59.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_stadttunnel)

Auto generated R starter code for data set geo_stadttunnel.
...
- **Keywords** `Bauen und Wohnen,Mobilität`
- **Tags** `['geodaten', 'geoportal', 'polygondaten', 'stadttunnel', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:52:39.013270`
- **Metadata_modified** `2026-05-22T05:43:52.000230`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Stadttunnel?format=geojson_link"
```
