...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_naturschulen)

Auto generated R starter code for data set geo_naturschulen.
...
- **Tags** `['geodaten', 'geoportal', 'naturschule', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:56:41.655242`
- **Metadata_modified** `2026-06-13T06:50:41.537949`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Naturschulen?format=geojson_link"
```
