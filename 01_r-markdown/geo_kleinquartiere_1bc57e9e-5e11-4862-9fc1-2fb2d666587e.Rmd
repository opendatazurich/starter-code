...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Kleinquartiere»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/c65659e0-3e46-4f9e-8480-4aa99ae3a28f).
...
Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Kleinquartiere»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/c65659e0-3e46-4f9e-8480-4aa99ae3a28f).
...
Kleinquartiere Jahresstand 2026
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/c65659e0-3e46-4f9e-8480-4aa99ae3a28f.png)
...
- **Tags** `['aggregationsstufe', 'geodaten', 'geoportal', 'kleinquartiere', 'kleinraumige-einteilung', 'polygondaten', 'stadtische-einteilung', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:42:17.816436`
- **Metadata_modified** `2026-06-06T06:33:01.860226`
