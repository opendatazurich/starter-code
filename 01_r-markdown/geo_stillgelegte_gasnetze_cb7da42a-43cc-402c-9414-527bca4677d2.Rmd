...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Stillgelegte Gasnetze»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/c84a5742-a066-4724-8402-925aa8e17181).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/c84a5742-a066-4724-8402-925aa8e17181.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_stillgelegte_gasnetze)

Auto generated R starter code for data set geo_stillgelegte_gasnetze.
...
- **Metadata_created** `2024-07-18T04:30:46.287198`
- **Metadata_modified** `2025-11-28T06:37:30.406999`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Stillgelegte_Gasnetze?format=geojson_link"
```
