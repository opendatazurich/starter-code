...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_weiterbildung)

Auto generated R starter code for data set geo_weiterbildung.
...
- **Tags** `['geodaten', 'geoportal', 'punktdaten', 'schule', 'stzh', 'vektordaten', 'weiterbildung']`
- **Metadata_created** `2026-04-29T05:48:45.175152`
- **Metadata_modified** `2026-06-13T06:41:31.130346`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Weiterbildung?format=geojson_link"
```
