...
## Dataset: ZSO Notfalltreffpunkte

Notfalltreffpunkte der Stadt Zürich bereitgestellt durch die Zivilschutz Organisation Zürich

**Zweck**: Übersicht der Notfalltreffpunkte der Stadt Zürich

**Genereller Hinweis zum Geodatensatz:**


Weitere Informationen zu diesem Datensatz finden sie unter [«**ZSO Notfalltreffpunkte»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/557cd4c8-9bb6-4f2d-aa28-c34ca769bbe0).				
			   

**Informationen zum Datensatz:**

Dokumentation der Notfalltreffpunkte der ZSO Zürich

**Datenerfassung:**

Umwandlung Excel mit FME zu GeoPackage 

**Datengrundlage:**

Excel Tabelle erstellt durch die ZSO Zürich


**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/557cd4c8-9bb6-4f2d-aa28-c34ca769bbe0.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_zso_notfalltreffpunkte)

Auto generated R starter code for data set geo_zso_notfalltreffpunkte.
...
- **Tags** `['geodaten', 'geoportal', 'notfall', 'ntp', 'punktdaten', 'stzh', 'treffpunkt', 'vektordaten', 'zso']`
- **Metadata_created** `2023-12-08T04:00:58.344119`
- **Metadata_modified** `2025-11-08T06:28:39.651262`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/ZSO_Notfalltreffpunkte?format=geojson_link"
```
