...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Strassenlärmsanierung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/42a6a82b-877b-496d-b063-4da4946f02f8).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Strassenlärmsanierung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/42a6a82b-877b-496d-b063-4da4946f02f8).
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/42a6a82b-877b-496d-b063-4da4946f02f8.png)
...
- **Keywords** `Umwelt`
- **Tags** `['geodaten', 'geoportal', 'liniendaten', 'polygondaten', 'punktdaten', 'stzh']`
- **Metadata_created** `2023-11-06T03:23:55.598318`
- **Metadata_modified** `2025-09-06T06:40:24.963469`
