...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Recyclinghof»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/e736d23b-57f7-4ba8-b4a4-18587a182251).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/e736d23b-57f7-4ba8-b4a4-18587a182251.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_recyclinghof)

Auto generated R starter code for data set geo_recyclinghof.
...
- **Tags** `['abfall', 'cargo', 'geodaten', 'geoportal', 'punktdaten', 'sammelstelle', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:46:13.393249`
- **Metadata_modified** `2026-05-16T06:35:14.607379`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Recyclinghof?format=geojson_link"
```
