...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Behindertenparkplätze»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/3cdde176-3f86-88d8-0a25-92226fce4ceb).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/3cdde176-3f86-88d8-0a25-92226fce4ceb.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_behindertenparkplaetze)

Auto generated R starter code for data set geo_behindertenparkplaetze.
...
- **Keywords** `Mobilität`
- **Tags** `['behindert', 'behindertenausweis', 'behindertenparkplatze', 'gehbehinderte', 'geodaten', 'geoportal', 'punktdaten', 'rollstuhl', 'rollstuhlparkplatze', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:53:24.714777`
- **Metadata_modified** `2026-05-16T06:39:00.895556`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Behindertenparkplaetze?format=geojson_link"
```
