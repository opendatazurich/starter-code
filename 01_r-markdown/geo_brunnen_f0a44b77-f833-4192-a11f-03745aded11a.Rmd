...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Brunnen»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/876cc251-9064-437a-94c6-5551318a1cd3).				
			   

**Datenerfassung:**

Brunnen werden nach deren Erstellung mittels gps aufgenommen und ins GIS integriert.

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/876cc251-9064-437a-94c6-5551318a1cd3.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_brunnen)

Auto generated R starter code for data set geo_brunnen.
...
- **Tags** `['brunnen', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten', 'wasserversorgung']`
- **Metadata_created** `2026-04-29T05:43:17.957492`
- **Metadata_modified** `2026-05-07T06:33:26.106056`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Brunnen?format=geojson_link"
```
