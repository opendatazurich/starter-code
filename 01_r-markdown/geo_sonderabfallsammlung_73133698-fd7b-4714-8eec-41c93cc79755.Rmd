...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Sonderabfallsammlung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/ec620157-e2d8-4cea-b630-876930639daf).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Sonderabfallsammlung»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/ec620157-e2d8-4cea-b630-876930639daf).

***POI_SONDERABFALL_ATT***: 

Zusatzinformationen zu den Standorten der Sonderabfallsammlung in der Stadt Zürich


***POI_SONDERABFALL_VIEW***: 

Standorte der Sonderabfallsammlung in der Stadt Zürich
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/ec620157-e2d8-4cea-b630-876930639daf.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_sonderabfallsammlung)

Auto generated R starter code for data set geo_sonderabfallsammlung.
...
- **Tags** `['abfall', 'geodaten', 'geoportal', 'punktdaten', 'sammelstelle', 'sonderabfall', 'stzh']`
- **Metadata_created** `2026-04-29T05:47:55.550335`
- **Metadata_modified** `2026-05-06T06:42:10.072144`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Sonderabfallsammlung?format=geojson_link"
```
