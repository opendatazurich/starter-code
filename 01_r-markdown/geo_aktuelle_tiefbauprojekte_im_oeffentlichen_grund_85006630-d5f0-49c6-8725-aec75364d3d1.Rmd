...
- **Metadata_modified** `2025-02-26T04:31:29.037807`
...
df <- read_geodata("# name: 		Aktuelle_Tiefbauprojekte_im_oeffentlichen_Grund.json (GeoJSON-Services)
# filename: 		nan
# format: 		JSON
# url: 		https://www.stadt-zuerich.ch/geodaten/download/Aktuelle_Tiefbauprojekte_im_oeffentlichen_Grund?format=geojson_link
# id: 		85006630-d5f0-49c6-8725-aec75364d3d1
...
library(readr) 
df <- read_csv("https://www.stadt-zuerich.ch/geodaten/download/Aktuelle_Tiefbauprojekte_im_oeffentlichen_Grund?format=geojson_link")", typename)
```
