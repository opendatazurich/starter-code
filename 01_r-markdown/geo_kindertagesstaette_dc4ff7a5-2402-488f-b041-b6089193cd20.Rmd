...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Kindertagesstätte»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/38c83b06-a3d3-4b9b-a033-527f8265d0a2).				
...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_kindertagesstaette)

Auto generated R starter code for data set geo_kindertagesstaette.
...
- **Tags** `['geodaten', 'geoportal', 'kindertagesstatte', 'punktdaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:44:02.376518`
- **Metadata_modified** `2026-06-06T06:34:32.028550`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Kindertagesstaette?format=geojson_link"
```
