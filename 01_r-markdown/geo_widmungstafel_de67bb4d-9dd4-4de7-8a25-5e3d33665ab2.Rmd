...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Widmungstafel»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/7636832e-cb4f-4a09-aa82-5ae56d0d51c3).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/7636832e-cb4f-4a09-aa82-5ae56d0d51c3.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_widmungstafel)

Auto generated R starter code for data set geo_widmungstafel.
...
- **Keywords** `Mobilität`
- **Tags** `['geodaten', 'geoportal', 'punktdaten', 'stzh', 'vektordaten', 'widmung-personlichkeit-strasse-namen-archiv']`
- **Metadata_created** `2026-04-29T05:42:58.609135`
- **Metadata_modified** `2026-05-16T06:32:37.139937`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Widmungstafel?format=geojson_link"
```
