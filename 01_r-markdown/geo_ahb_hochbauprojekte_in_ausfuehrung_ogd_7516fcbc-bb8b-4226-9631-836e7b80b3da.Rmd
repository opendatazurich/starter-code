...
- **Metadata_modified** `2025-03-17T04:39:51.637835`
...
layers <- get_wfs_layers("https://www.stadt-zuerich.ch/geodaten/download/AHB_Hochbauprojekte_in_Ausfuehrung_OGD?format=geojson_link")
...
df <- read_geodata("https://www.stadt-zuerich.ch/geodaten/download/AHB_Hochbauprojekte_in_Ausfuehrung_OGD?format=geojson_link", typename)
```
