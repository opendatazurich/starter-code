...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_move_and_chill)

Auto generated R starter code for data set geo_move_and_chill.
...
- **Keywords** `Bevölk­erung,Umwelt`
- **Tags** `['geodaten', 'geoportal', 'larm', 'move-and-chill', 'punktdaten', 'sensoren', 'stzh', 'temperatur', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:48:31.583696`
- **Metadata_modified** `2026-05-06T06:42:26.972130`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Move_and_Chill?format=geojson_link"
```
