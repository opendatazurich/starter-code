...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Kreisschulbehörde»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/a704e095-c761-439b-b8ec-e43bb233639a).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/a704e095-c761-439b-b8ec-e43bb233639a.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_kreisschulbehoerde)

Auto generated R starter code for data set geo_kreisschulbehoerde.
...
- **Metadata_created** `2026-04-29T05:44:24.221448`
- **Metadata_modified** `2026-06-20T06:36:39.364876`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Kreisschulbehoerde?format=geojson_link"
```
