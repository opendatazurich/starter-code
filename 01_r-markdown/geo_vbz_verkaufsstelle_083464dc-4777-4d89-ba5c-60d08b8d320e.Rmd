...
Weitere Informationen zu diesem Datensatz finden sie unter [«**VBZ-Verkaufsstelle»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/0f35c07c-d30d-42a1-bea4-d8c9052dc36c).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/0f35c07c-d30d-42a1-bea4-d8c9052dc36c.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_vbz_verkaufsstelle)

Auto generated R starter code for data set geo_vbz_verkaufsstelle.
...
- **Keywords** `Mobilität`
- **Tags** `['bus', 'buslinien', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'strassenbahn', 'stzh', 'tram', 'tramlinien', 'vbg', 'vbz', 'vektordaten', 'verkauf']`
- **Metadata_created** `2026-04-29T05:49:43.264815`
- **Metadata_modified** `2026-06-27T06:39:45.373248`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/VBZ_Verkaufsstelle?format=geojson_link"
```
