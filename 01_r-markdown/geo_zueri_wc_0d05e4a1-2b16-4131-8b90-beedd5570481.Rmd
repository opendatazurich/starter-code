...
Es handelt sich hierbei um einen Geodatensatz, welcher aus mehreren Geodatenelmenten besteht. Diese Geodatenelemente werden hier nicht im Detail beschrieben. Sie finden jedoch sämtliche Informationen - wie beispielsweise die Attributbeschreibungen - [«**Züri WC»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/7f1573b1-c14f-4fd2-9a21-34c10b150a44).
			   

**Geodatenelemente:**

Die vollständige Metadatenbeschreibung der Geodatenelemente finden Sie ebenfalls unter [«**Züri WC»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/md.viewer#/full_view/7f1573b1-c14f-4fd2-9a21-34c10b150a44).
...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_zueri_wc)

Auto generated R starter code for data set geo_zueri_wc.
...
- **Tags** `['bagno', 'geodaten', 'geoportal', 'punktdaten', 'stzh', 'toilette', 'wc']`
- **Metadata_created** `2026-04-29T05:53:58.216707`
- **Metadata_modified** `2026-05-16T06:39:19.052609`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Zueri_WC?format=geojson_link"
```
