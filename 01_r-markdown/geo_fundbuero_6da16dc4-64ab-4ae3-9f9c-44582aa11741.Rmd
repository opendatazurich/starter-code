...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Fundbüro»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/b977ee31-0c5d-418b-bac4-83f5e9fd11ef).				
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/b977ee31-0c5d-418b-bac4-83f5e9fd11ef.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_fundbuero)

Auto generated R starter code for data set geo_fundbuero.
...
- **Keywords** `Mobilität`
- **Tags** `['bus', 'buslinien', 'fundburo', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'strassenbahn', 'stzh', 'tram', 'tramlinien', 'vbg', 'vbz', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:56:09.505025`
- **Metadata_modified** `2026-06-20T06:50:17.346539`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Fundbuero?format=geojson_link"
```
