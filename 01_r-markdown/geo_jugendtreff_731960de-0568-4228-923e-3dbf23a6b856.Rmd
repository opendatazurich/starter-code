...
[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_jugendtreff)

Auto generated R starter code for data set geo_jugendtreff.
...
- **Metadata_created** `2026-04-29T05:50:51.973921`
- **Metadata_modified** `2026-05-16T06:37:49.504094`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Jugendtreff?format=geojson_link"
```
