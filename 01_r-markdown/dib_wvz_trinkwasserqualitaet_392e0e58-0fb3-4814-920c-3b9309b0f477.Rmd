...
- **Tags** `['chemie', 'gitlab', 'mikrobiologie', 'mikroverunreinigungen', 'sachdaten', 'spurenstoffe', 'tabelle', 'trinkwasser', 'trinkwasserqualitaet', 'zeitreihe']`
- **Metadata_created** `2025-01-29T12:23:17.536931`
- **Metadata_modified** `2026-06-20T21:59:03.511040`
...
```{r}
url <- "https://data.stadt-zuerich.ch/dataset/dib_wvz_trinkwasserqualitaet/download/2025_Trinkwasserqualitaet.csv"
