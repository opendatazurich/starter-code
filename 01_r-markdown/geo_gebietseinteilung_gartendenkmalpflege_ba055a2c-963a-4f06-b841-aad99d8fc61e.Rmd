...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Gebietseinteilung Gartendenkmalpflege»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/fe64eeba-1583-44ca-90ba-4846ddb8dd5d).				
			   

**Datenerfassung:**

Die Einteilung basiert vorwiegend auf den Flächen der Stadtkreise. Weitere zusätzliche Flächenunterteilungen sind entlang der statistischen Quartiere und speziellen Gebieten definiert.
...
![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/fe64eeba-1583-44ca-90ba-4846ddb8dd5d.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_gebietseinteilung_gartendenkmalpflege)

Auto generated R starter code for data set geo_gebietseinteilung_gartendenkmalpflege.
...
- **Tags** `['gartendenkmalpflege', 'gdp', 'gebietseinteilung', 'geodaten', 'geoportal', 'polygondaten', 'stzh', 'vektordaten']`
- **Metadata_created** `2026-04-29T05:41:09.506846`
- **Metadata_modified** `2026-05-09T06:32:14.819238`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Gebietseinteilung_Gartendenkmalpflege?format=geojson_link"
```
