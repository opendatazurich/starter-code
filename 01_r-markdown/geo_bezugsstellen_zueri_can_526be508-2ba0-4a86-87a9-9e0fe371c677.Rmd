...
Weitere Informationen zu diesem Datensatz finden sie unter [«**Bezugsstellen Züri Can»** auf Geocat.ch](https://www.geocat.ch/geonetwork/srv/ger/catalog.search#/metadata/a1c84dea-4c93-4313-8c5f-bd92e34fea8f).				
			   

**Statisches Vorschaubild:**

![BildText](https://www.gis.stadt-zuerich.ch/zueriplan_docs/geocat/a1c84dea-4c93-4313-8c5f-bd92e34fea8f.png)



[Direct link by **OpenDataZurich** for dataset](https://data.stadt-zuerich.ch/dataset/geo_bezugsstellen_zueri_can)

Auto generated R starter code for data set geo_bezugsstellen_zueri_can.
...
- **Metadata_created** `2026-04-29T05:45:12.598677`
- **Metadata_modified** `2026-05-13T06:37:59.793172`
...
data link
```{r}
url <- "https://www.stadt-zuerich.ch/geodaten/download/Bezugsstellen_Zueri_Can?format=geojson_link"
```
