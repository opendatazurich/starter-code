...
This repository provides currently 2 x 1261 code files (1 x R, 1 x Python) for all data sets (*«resources»*) that are available on [OpenDataZurich](https://data.stadt-zuerich.ch/) and that contain one or several CSV/parquet/geojson distributions.
...
<sub>Latest update: **2025-06-29 03:55:37**</sub><br>
