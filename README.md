...
This repository provides currently 2 x 1312 code files (1 x R, 1 x Python) for all data sets (*«resources»*) that are available on [OpenDataZurich](https://data.stadt-zuerich.ch/) and that contain one or several CSV/parquet/geojson distributions.
...
<sub>Latest update: **2025-11-23 03:56:19**</sub><br>
